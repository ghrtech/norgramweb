            ...
            if(curIndex>=(slideCount-1)){
                ...
                $(".section-wrapper").css({
                   // "transform": "translate3d("+(-50*(curIndex-2))+"%, 0px, 0px)",
                    "transform": "translate3d("+(-10*(curIndex-2))+"%, 0px, 0px)",
                });
                ...
                for(i=0;i<slideCount;i++) {
                    if (i == (curIndex - 1) || i == (curIndex - 2)) {
                        ...
                        $("#section-" + i).removeClass("active").css("width", "10%");
                    }
                }
                ...
                $(".section-wrapper").css({
                    "transform": "translate3d("+(-10*curIndex)+"%, 0px, 0px)",
                });
        ...
        onProgress: function(swiper, progress){
            ...
            if(index>=(slideCount-1)){
                ...
                $(".section-wrapper").css({
                    ...
                    "transform": "translate3d("+((-10*(index-2))+(10*indexProgress)*rate )+"%, 0px, 0px)",
                ...
                if(indexProgress>0){
                    ...
                    $(".section-wrapper").css({
                        "transform": "translate3d("+((-10*(index))+(10*indexProgress)*rate )+"%, 0px, 0px)",
            ...
            if(index>0 && index<(slideCount-2)){
                ...
                if(indexProgress>0){
                    ...
                    $curSection.css({
                        "width":(50-40*indexProgress*rate)+"%",
                        "-webkit-transition-timing-function":"ease-in",
                        "-ms-transition-timing-function":"ease-in",
                        "transition-timing-function":"ease-in"
                    ...
                    $prevSection.css({
                        // "width":(20+30*indexProgress*rate)+"%",
                        "width":(10-40*indexProgress*rate)+"%",
                        "-webkit-transition-timing-function":"ease-out",
                        "-ms-transition-timing-function":"ease-out",
                        "transition-timing-function":"ease-out"
