    ...
    function setPosition(){
        ...
        requestAnimationFrame(function(){
            ...
            if(curIndex>=(slideCount-1)){
                ...
                $(".section-wrapper").css({
                    "transform": "translate3d("+(-45*curIndex)+"%, 0px, 0px)",
                });
                ...
                $(".section-slide").each(function(i,e){
                    if(i>curIndex){
                        ...
                        $(this).css("width","45%").removeClass("active");
                    }else{
        ...
        onProgress: function(swiper, progress){
            ...
            if(index>=(slideCount-1)){
                ...
                $(".section-wrapper").css({
                    ...
                    "transform": "translate3d("+((-45*(index-2))+(20*indexProgress)*rate )+"%, 0px, 0px)",
                ...
                if(indexProgress>0){
                    ...
                    $(".section-wrapper").css({
                        "transform": "translate3d("+((-45*(index))+(20*indexProgress)*rate  )+"%, 0px, 0px)",
                    ...
                    $(".section-wrapper").css({
                        "transform": "translate3d("+((-45*(index))-(45*indexProgress)*rate  )+"%, 0px, 0px)",
...
function setPage(){
    $(".section-slide").each(function(i,e){
       $(this).css("transform","translateZ("+(10*i+9)+"px)");
    });
    setBottom();
    setScale();
    setImageWidth();
