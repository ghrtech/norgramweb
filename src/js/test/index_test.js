...
$(document).ready(function(){
        ...
        requestAnimationFrame(function(){
            ...
            if(curIndex<0){
               ...
               /* $(".section-slide").each(function(i,e){
                ...
                $(".section-slide").css("width","20%").removeClass("active");
                $("#section-0").css("width","50%").addClass("active");
            ...
            if(curIndex>=(slideCount-1)){
                ...
                $(".section-slide").css("width","50%").removeClass("active");
              ...
              /*  $(".section-slide").each(function(i,e){
                ...
                for(i=0;i<slideCount;i++){
                    if(i<curIndex){
                        $("#section-"+i).css("width","50%").removeClass("active");
                    }else if(i==curIndex){
                        $("#section-"+curIndex).css("width","50%").addClass("active");
                    }else{
                        $("#section-"+i).css("width","20%").removeClass("active");
                    }
                }
    ...
    function setPositionWorker(){
         if(checkPositionWorker){
             console.log("clearTimeout========================")
             clearTimeout(checkPositionWorker);
             checkPositionWorker=null;
             console.log(checkPositionWorker);
         }
         if(!checkPositionWorker){
             console.log("timeout==============================");
    ...
    var sectionAnim=null;
    var sectionWidthAnim=null;
    var halfRate=0.6;
        ...
        onProgress: function(swiper, progress){
            ...
            if(index>=(slideCount-1)){
               ...
               /* var indexProgress=swiper.slides[index].progress;
                ...
                if(indexProgress !==0){
                    if(!sectionAnim){
                        sectionAnim=requestAnimationFrame(function(){
                            ...
                            cancelAnimationFrame(sectionAnim);
                            sectionAnim=null;
          ...
          /*  if(indexProgress >0){
            ...
            if(index>0 && index<(slideCount-2)){
                ...
                if(indexProgress>0){
                    //当前slide移走
                    if(!sectionWidthAnim){
                        sectionWidthAnim=requestAnimationFrame(function(){
                            ...
                            cancelAnimationFrame(sectionWidthAnim);
                            sectionWidthAnim=null;
